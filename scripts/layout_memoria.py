...
benchmark = Benchmark("layout_memoria")
...
fig.write_html(Path("../resources/layout_memoria_tempo_execucao.html"))
...
fig.update_traces(textposition="bottom right")
fig.write_html(Path("../resources/layout_memoria_fps.html"))
