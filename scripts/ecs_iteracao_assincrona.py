...
benchmark = Benchmark("ecs_iteracao_assincrona")
...
fig = px.line(
    ...
    y="Tempo(ms)",
    color="Cenário",
    title="Tempo de execução de iterações assincronas",
    text="Tempo",
    markers=True,
)
fig.update_traces(textposition="bottom right")
fig.write_html(Path("../resources/ecs_iteracao_assincrona_tempo_execucao.html"))
...
fig = px.line(
    ...
    range_y=[0, 1000],
    color="Cenário",
    title="Taxa de atualização de iterações assincronas",
    text="Quadros",
    markers=True,
)
fig.update_traces(textposition="bottom right")
fig.write_html(Path("../resources/ecs_iteracao_assincrona_fps.html"))
